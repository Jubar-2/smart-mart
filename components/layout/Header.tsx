import { Search, ShoppingBag, Heart, RefreshCw, ChevronDown, Menu } from "lucide-react";
      ...
      <div className="border-b py-6 bg-white">
        <div className="container mx-auto px-4 flex items-center justify-between gap-8">
          ...
          <div className="flex-1 max-w-2xl flex border rounded-md overflow-hidden">
            ...
            <Input className="border-0 focus-visible:ring-0 flex-1" placeholder="Search by product name..." />
            <Button variant="ghost" className="rounded-none px-4"><Search size={20}/></Button>
          </div>
